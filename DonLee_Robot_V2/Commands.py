...
async def help(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          ...
          Import.Button("⚠️𝖱𝖾𝗉𝗈𝗋𝗍⚠️", callback_data="report"),
...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("🔥updates", url='t.me/thanimaibots'),
          Import.Button("𝖲upport🥳", url="t.me/thanimaisupport")
          ],[
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.me/sarbudeen786")
       ]]
    await msg.reply_text(
